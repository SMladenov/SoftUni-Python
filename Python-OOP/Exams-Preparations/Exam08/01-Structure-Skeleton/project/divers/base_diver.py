...
class BaseDiver (ABC):
    ...
    @oxygen_level.setter
    def oxygen_level (self, oxygen_level: float):
        if oxygen_level < 0:
    ...
    def competition_points (self, competition_points: float):
        self.__competition_points = competition_points
    ...
    def update_health_status (self):
        if self.has_health_issue == False:
